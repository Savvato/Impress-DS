...
$.Redactor.prototype.scriptbuttons = function()
{
    return {
        init: function()
        {
            var sup = this.button.add('superscript', 'Степень');
            var sub = this.button.add('subscript', 'Показатель');
 
            // make your added buttons as Font Awesome's icon
            this.button.setAwesome('superscript', 'mdi-editor-vertical-align-top');
            this.button.setAwesome('subscript', 'mdi-editor-vertical-align-bottom');
